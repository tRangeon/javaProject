...
public class DonnerArgent implements Comportement {
	...
	/**
	 * Constructeur du comportement DonnerArgent
	 * Le PNJ donnera de l'argent au joueur, selon le contexte il peut:
	 * -faire un simple don (contexte = 0)
	 * -faire un remboursement au joueur (contexte = 1)
	 * @param joueur
	 * @param montant
	 * @param contexte 0 = don; 1 = remboursement
	 */
	 ...
	 * @param cePNJ PNJ qui va donner l'argent
	 */

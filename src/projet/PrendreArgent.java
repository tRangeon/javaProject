...
public class PrendreArgent implements Comportement {
	...
	/**
	 * Constructeur du comoportement PrendreArgent. Le PNJ prendra de l'argent
	 * au joueur, selon le contexte il peut: - voler l'argent du joueur
	 * (contexte = 0) - emprunter de l'argent au joueur (contexte = 1)
	 * 
	 * @param joueur
	 * @param montant
	 * @param contexte
	 *            0 = voler argent; 1 = emprunter argent
	 */
	 ...
	 * 
	 * @param cePNJ
	 *            Le PNJ qui va prendre l'argent
	 */
